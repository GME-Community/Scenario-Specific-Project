...
using UnityEngine;
	...
	private AudioSource source;
		...
		public void installBackGround()
		{
			...
			source.loop = true;
			AudioClip	ac =  Resources.Load<AudioClip>("BackGroundMusic/3");
			source.clip = ac;
			UnityEngine.Debug.LogFormat("installBackGround ");
		}

		public AudioSource getAudioSoucre ()
		{
			return source;
		}
		public static BackGroundMusicHelper getInstanceGroundMusicHelper()
		{
			...
			lock (sLock) {
				if (sInstance == null) {
					...
					UnityEngine.Debug.LogFormat("BackGroundMusicHelper:{0},{1}", obj.GetInstanceID(), sInstance);
